...
module.exports = {
    ...
    ScannerName : trans('scanners.machineoutlookaddin'),
    ...
    scan : function(){
        let ps = new shell({
          ...
          ps.addCommand("Get-ChildItem -Path HKLM:\\Software\\Microsoft\\Office\\Outlook\\Addins,HKLM:\\Software\\WOW6432Node\\Microsoft\\Office\\Outlook\\Addins -ErrorAction SilentlyContinue | ForEach-Object { Get-ItemProperty $_.pspath } | Select-Object PSChildName, FriendlyName | ConvertTo-Json -Compress | Out-File '" + fileManager.getLastScanFileName() + "' -Encoding utf8 -Force");
          return ps.invoke();
    },
