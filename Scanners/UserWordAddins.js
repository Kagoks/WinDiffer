...
module.exports = {
    ...
    ScannerId : "userwordaddin",
    ScannerName : "Microsoft Word Addins - User",
    ...
    scan : function(){
        let ps = new shell({
          ...
          ps.addCommand("Get-ChildItem -Path HKCU:\\Software\\Microsoft\\Office\\Word\\Addins,HKCU:\\Software\\WOW6432Node\\Microsoft\\Office\\Word\\Addins -ErrorAction SilentlyContinue | ForEach-Object { Get-ItemProperty $_.pspath } | Select-Object PSChildName, FriendlyName | ConvertTo-Json -Compress");
          return ps.invoke();
    },
